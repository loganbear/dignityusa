...
{if $form.spouseFirstName.value}
<fieldset class="crm-group spouseInfo-group" id="spouseInfo">
  <div class="header-dark">{ts}Spouse Information{/ts}</div>
  <div class="crm-section spouseInfo-section">
    <div class="label">{ts}Spouse Name{/ts}</div>
    <div class="content">{$form.spouseFirstName.value} {$form.spouseLastName.value}</div>
    <div class="clear"></div>
    <div class="label">{ts}Spouse Email{/ts}</div>
    <div class="content">{$form.spouseEmail.value}</div>
    <div class="clear"></div>
  </div>
</fieldset>
{/if}
